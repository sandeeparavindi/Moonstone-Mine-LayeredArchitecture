...
public class AdminFormController implements Initializable {
    ...
    @FXML
    void btnMonthlyReportOnAction(ActionEvent event) throws IOException {
        this.pane.getChildren().clear();
        this.pane.getChildren().add(FXMLLoader.
                load(this.getClass().getResource("/view/monthlyIncome_form.fxml")));
    }
    ...
    void btnEmployeeOnAction(ActionEvent event) throws IOException {
        this.pane.getChildren().clear();
        this.pane.getChildren().add(FXMLLoader.
                load(this.getClass().getResource("/view/employee_form.fxml")));
    }
    ...
    void btnHomeOnAction(ActionEvent event) throws IOException {
        Stage stage = (Stage) pane.getScene().getWindow();
        stage.setScene(new Scene(FXMLLoader.
                load(getClass().getResource("/view/admin_form.fxml"))));
        stage.centerOnScreen();
        stage.show();
    }
    ...
    @FXML
    void btnMonthlyTourIncomeOnAction(ActionEvent event) throws IOException {
        this.pane.getChildren().clear();
        this.pane.getChildren().add(FXMLLoader.
                load(this.getClass().getResource("/view/monthlyIncomeTour_form.fxml")));
    }
